...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white flex flex-col items-center justify-center p-6 font-outfit relative overflow-hidden selection:bg-blue-500/30">
      ...
      <div className="glass-panel w-full max-w-md p-12 relative z-10 shadow-2xl border border-white/10 backdrop-blur-3xl bg-white/5">
        <div className="mb-12">
          ...
          <p className="text-white/50 font-medium">Authenticate to enter the portal.</p>
        </div>
